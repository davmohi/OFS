export async function readData() {
    // Aquí, por ahora estamos devolviendo datos dummy, pero en el futuro podrías reemplazar esta implementación
    // con la lógica necesaria para leer desde un sistema de archivos o una base de datos.
    return {
      members: [
